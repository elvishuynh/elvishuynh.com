    ...
    return (
        ...
        <div className="scene col-span-1 row-span-2 h-full" style={{ perspective: '1500px' }}>
            ...
            >
                {/* === FRONT FACE === */}
                <div
                    className="face front absolute inset-0"
                    style={{ backfaceVisibility: 'hidden', transformStyle: 'preserve-3d' }}
                >
                    {/* Layer A: The Base Card (Background) */}
                    <div
                        className="layer-base absolute inset-0 rounded-3xl bg-white border border-gray-200 shadow-xl"
                ...
                >
                    {/* Layer A: The Base Card (Background) */}
                    <div
                        className="layer-base absolute inset-0 rounded-3xl bg-[#1c1c1c] shadow-xl"
                        style={{ transform: 'translateZ(0px)' }}
                    ></div>
                    ...
                    >
                        ...
                        <div className="flex-1 flex items-center justify-center relative">
                            <svg viewBox="0 0 100 100" className="w-32 h-32 opacity-80">
                                ...
                                <polygon points="50,25 75,40 65,70 35,70 25,40" fill="rgba(0,255,255,0.2)" stroke="#00ffff" strokeWidth="1" />
                                <line x1="50" y1="50" x2="50" y2="10" stroke="rgba(255,255,255,0.1)" />
                                <line x1="50" y1="50" x2="90" y2="35" stroke="rgba(255,255,255,0.1)" />
                                <line x1="50" y1="50" x2="75" y2="85" stroke="rgba(255,255,255,0.1)" />
                                <line x1="50" y1="50" x2="25" y2="85" stroke="rgba(255,255,255,0.1)" />
                                <line x1="50" y1="50" x2="10" y2="35" stroke="rgba(255,255,255,0.1)" />
                            </svg>
                        </div>

                        {/* Text Content */}
                        <div className="mt-6 text-center">
                            <h3 className="text-3xl font-bold text-white mb-1">GOAL</h3>
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); handleFlip(); }}
                            className="w-full mt-8 py-3 rounded-full bg-white/10 text-white text-sm font-bold border border-white/20 hover:bg-white/20 transition-colors pointer-events-auto"
                        >
                            Flip me
                        </button>
                    </div>
