...
export default function MeasuringStepper() {
    ...
    useEffect(() => {
        ...
        if (initialTick) {
            gsap.set(initialTick, { scaleY: 2.0, opacity: 1 });
        }
        ...
        const tickerFn = () => {
            ...
            boundaryTickRefs.current.forEach((tick, i) => {
                ...
                const targetScale = 1 + (2.0 - 1) * smoothedProximity;
                const targetWidth = 1.5 + (2.5 - 1.5) * smoothedProximity;
    ...
    return (
        <div
            ...
            style={{
                ...
                maskImage:
                    "linear-gradient(to right, transparent 0%, transparent 25%, black 40%, black 100%)",
                WebkitMaskImage:
                    "linear-gradient(to right, transparent 0%, transparent 25%, black 40%, black 100%)",
            }}
        >
